...
namespace ErrorLogger.Storage.SQL
{
    ...
    public class DatabaseReader : IDisposable
    {
        ...
        public DatabaseReader(IDataReader reader, string description)
        {
            this.reader = reader;
        ...
        */
        ...
        public bool GetBooleanNotNull(string name)
        {
            ...
            {
                throw new System.Data.SqlTypes.SqlNullValueException("Field " + "'" + name + "' returned an invalid null.", ex);
            }
        }
        ...
        public string GetStringNotNull(string name)
        {
            ...
            {
                throw new System.Data.SqlTypes.SqlNullValueException("Field " + "'" + name + "' returned an invalid null, Reader: '" + this.Description + "'", ex);
            }
        }
        #endregion
